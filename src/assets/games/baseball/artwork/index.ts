 ...
 *
 * 선수 그림은 **자세 × 모양**으로 불어난다 — 자세 다섯에 실루엣·윤곽선 두 벌씩
 * 열이다. 목록을 손으로 적지 않고 자세 표(`../dimensions.ts`)에서 만들어, 자세를
 * 더하면 파일도 저절로 따라 나온다. 빈 원은 자세와 무관해 파일 하나를 모든 세트가
 * 나눠 쓴다.
 */
