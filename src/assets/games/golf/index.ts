...
export default defineGame({
  ...
  description:
    ...
    `파 ${COURSE_PAR}를 빼면 오늘의 성적이다. 지난 라운드의 총타수를 한 번 더 ` +
    '빼면 지난번보다 얼마나 나아졌는지가 나온다 — 좋아질수록 작아지니 그 수는 ' +
    '이따금 0보다 작다. 숫자를 쓰고 더하고 빼는 일이 ' +
  ...
  parts: [
    ...
    },
    {
      ...
      description:
        ...
        '둘을 더하는 합산 칸이 있다. 합산 칸에서 파와 견주고, 지난 라운드와도 ' +
        '견준다 — 어느 쪽이 +이고 어느 쪽이 −인지는 칸 이름 아래 적혀 있다. ' +
        '파와 거리는 인쇄되어 있고 타수와 이름은 ' +
