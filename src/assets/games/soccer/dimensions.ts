...
export const SHEETS = {
  ...
  /**
   * 골대 전개도 **한 벌** + 조립 안내 — A4 가로 한 장에 딱 들어가는 크기.
   *
   * 뚜껑이 붙으면서(2026-09-08) 전개도 한 벌이 134×108mm가 됐다. 두 벌을 한 장에
   * 앉히려면 위아래로 216mm, 나란히 놓으면 268mm가 드는데 둘 다 접는 법 자리를
   * 남기지 못한다. 그래서 **한 장에 한 벌**로 바꾸고 `defaultCopies`를 2로 올렸다
   * — 골대 두 개면 종이 두 장이다.
   *
